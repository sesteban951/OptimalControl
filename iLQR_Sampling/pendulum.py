...
def linearize_sampling_based(x, u, params):
    ...
    f_plus  = f_cont(x_plus_flat,  u_plus_flat,  params).reshape(batch_size, K, n)
    f_minus = f_cont(x_minus_flat, u_minus_flat, params).reshape(batch_size, K, n)
...
if __name__ == "__main__":
    ...
    Ac_true = Ac(x, u, params)
    Bc_true = Bc(x, u, params)
    Cc_true = Cc(x, u, params)
